...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-brand" style="justify-content: center; padding: 20px 0;">
        <a href="index.php" class="sidebar-logo-link" style="flex-direction: column; align-items: center; text-decoration: none;">
            ...
            <div class="sidebar-logo-text" style="text-align: center; margin-top: 8px;">
                <span class="sl-name" style="font-size: 16px; letter-spacing: 1px;"><?= htmlspecialchars($displayOrgName) ?> <span style="color:#facc15;"><?= htmlspecialchars($displayOrgSub) ?></span></span>
                <span class="sl-sub" style="font-size: 9px; opacity: 0.8; letter-spacing: 0.5px;"><?= htmlspecialchars($displayOrgSlogan) ?></span>
            </div>
        </a>
    </div>
    ...
    <div class="sidebar-help" style="margin-top: auto; padding: 20px;">
        <div class="help-card" style="background: transparent; border: 1px solid rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; text-align: center;">
            ...
            <div class="help-details">
                <span class="help-title" style="color: rgba(255,255,255,0.7); font-size: 11px; display: block; margin-bottom: 4px;">Need Help?</span>
                <a href="tel:" class="help-phone" style="color: #fff; font-weight: 600; font-size: 13px; text-decoration: none;">[Add Number Here]</a>
            </div>
        </div>
    </div>
</aside>
