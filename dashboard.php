...
=======
        'employees' => ['org_id' => 'INT NOT NULL DEFAULT 1', 'status' => "VARCHAR(50) NOT NULL DEFAULT 'Active'", 'public_key' => "TEXT DEFAULT NULL"],
        'projects' => ['org_id' => 'INT NOT NULL DEFAULT 1'],
        'tasks' => ['org_id' => 'INT NOT NULL DEFAULT 1'],
        'documents' => ['org_id' => 'INT NOT NULL DEFAULT 1'],
        'discussions' => ['org_id' => 'INT NOT NULL DEFAULT 1', 'is_direct' => 'TINYINT(1) DEFAULT 0'],
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
    ...
    // 11b. discussion_keys table (for E2EE AES keys)
    try {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `discussion_keys` (
            ...
            UNIQUE KEY `uniq_dk_disc_emp` (`discussion_id`, `employee_id`)
        ) ENGINE=InnoDB");
    } catch (PDOException $e) {
    }

    // 11c. calls table (for WebRTC signaling/ringing)
    try {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `calls` (
            ...
            `status` ENUM('ringing', 'active', 'ended') DEFAULT 'ringing',
            `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
            INDEX `idx_calls_discussion` (`discussion_id`)
        ) ENGINE=InnoDB");
    } catch (PDOException $e) {
    }
...
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
    ...
    $discStmt = $pdo->prepare("SELECT d.*, d.type as chat_type,
        (SELECT m.message FROM discussion_messages m WHERE m.discussion_id = d.id ORDER BY m.id DESC LIMIT 1) as last_message,
        (SELECT DATE_FORMAT(m.created_at, '%h:%i %p') FROM discussion_messages m WHERE m.discussion_id = d.id ORDER BY m.id DESC LIMIT 1) as last_message_time
        FROM discussions d 
        JOIN discussion_members dm ON d.id = dm.discussion_id 
        WHERE dm.employee_id = ? 
        ORDER BY d.id DESC");
    $discStmt->execute([$meId]);
    $discussionsList = $discStmt->fetchAll(PDO::FETCH_ASSOC);
...
=======
    <style type="text/css" media="print">
        ...
        #view-surveymanagement th,
        #view-surveymanagement td {
...
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
                        ...
                        <div class="rsk-grid-8">
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#eff6ff; color:#3b82f6;"><i
                                        data-lucide="folder"></i></div>
                                <div class="rsk-card-title">Total<br>Projects</div>
                                <div class="rsk-card-value"><?= $rsk_totalProjects ?></div>
                                <a href="#projects" class="rsk-card-link tab-trigger" data-target="projects"
                                    data-filter-status="All">View all projects &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#fef3c7; color:#f59e0b;"><i
                                        data-lucide="hourglass"></i></div>
                                <div class="rsk-card-title">Pending<br>Projects</div>
                                <div class="rsk-card-value"><?= $rsk_pendingProjects ?></div>
                                <a href="#projects" class="rsk-card-link tab-trigger" data-target="projects"
                                    data-filter-status="Pending">View pending &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#dcfce7; color:#10b981;"><i
                                        data-lucide="check-circle-2"></i></div>
                                <div class="rsk-card-title">Approved<br>Projects</div>
                                <div class="rsk-card-value"><?= $rsk_approvedProjects ?></div>
                                <a href="#projects" class="rsk-card-link tab-trigger" data-target="projects"
                                    data-filter-status="Active">View approved &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#fee2e2; color:#ef4444;"><i
                                        data-lucide="x-circle"></i></div>
                                <div class="rsk-card-title">Rejected /<br>Query</div>
                                <div class="rsk-card-value"><?= $rsk_rejectedProjects ?></div>
                                <a href="#projects" class="rsk-card-link tab-trigger" data-target="projects"
                                    data-filter-status="Rejected">View details &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#fce7f3; color:#ec4899;"><i
                                        data-lucide="users"></i></div>
                                <div class="rsk-card-title">Total<br>Employees</div>
                                <div class="rsk-card-value"><?= $rsk_totalEmployees ?></div>
                                <a href="#users" class="rsk-card-link tab-trigger" data-target="users">View employees
                                    &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#e0e7ff; color:#6366f1;"><i
                                        data-lucide="check-square"></i></div>
                                <div class="rsk-card-title">Total<br>Tasks</div>
                                <div class="rsk-card-value"><?= $rsk_totalTasks ?></div>
                                <a href="#tasks" class="rsk-card-link tab-trigger" data-target="tasks">View tasks &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#f3e8ff; color:#8b5cf6;"><i
                                        data-lucide="users"></i></div>
                                <div class="rsk-card-title">Active<br>Clients</div>
                                <div class="rsk-card-value"><?= $rsk_activeClients ?></div>
                                <a href="#clients" class="rsk-card-link tab-trigger" data-target="clients">View clients
                                    &rarr;</a>
                            </div>
                            <div class="rsk-card-sm">
                                <div class="rsk-icon-sm" style="background:#cffafe; color:#06b6d4;"><i
                                        data-lucide="map"></i></div>
                                <div class="rsk-card-title">Survey Works<br>In Progress</div>
                                <div class="rsk-card-value"><?= $rsk_surveyWorks ?></div>
                                <a href="#surveymanagement" class="rsk-card-link tab-trigger"
                                    data-target="surveymanagement">View surveys &rarr;</a>
                            </div>
                        </div>
                        ...
                        <div class="rsk-row-2">
                            <div class="rsk-panel">
                                <div class="rsk-panel-title">
                                    <span><i data-lucide="bar-chart-2"
                                            style="width:16px; height:16px; display:inline-block; vertical-align:middle; margin-right:4px; color:#3b82f6;"></i>
                                ...
                                <div class="rsk-stepper">
                                    ...
                                    foreach ($pipelineStages as $idx => $stage):
                                        $count = $pipelineCounts[$stage[0]] ?? 0;
                                        ?>
                                        <div class="rsk-step" style="cursor:pointer;"
                                            onclick="openStageModal('<?= htmlspecialchars($stage[0], ENT_QUOTES) ?>')"
                                            title="Click to see projects in '<?= htmlspecialchars($stage[0], ENT_QUOTES) ?>'">
                                            <div class="rsk-step-circle"
                                                style="background: <?= $stage[1] ?>; box-shadow: 0 0 0 2px <?= $stage[1] ?>33;">
                                                <?= $idx + 1 ?></div>
                                            <div class="rsk-step-title" style="color:#3b82f6; cursor:pointer;">
                                                <?= str_replace(' ', '<br>', htmlspecialchars($stage[0])) ?></div>
                                            <div class="rsk-step-count"
                                                style="<?= $count > 0 ? 'background:#eff6ff; border-color:#bfdbfe; color:#2563eb;' : '' ?>">
                                                <?= $count ?></div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <table class="rsk-table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($serviceNames as $sn):
                                            ...
                                            ?>
                                            <tr>
                                                <td style="color:#0f172a; font-weight:600;"><i data-lucide="<?= $sn[1] ?>"
                                                        style="width:12px; height:12px; color:<?= $sn[2] ?>; display:inline-block; vertical-align:middle; margin-right:4px;"></i>
                                                    <?= $sn[0] ?></td>
                                                <td style="text-align:center;"><?= $c['total'] ?></td>
                                                <td style="text-align:center;"><?= $c['pend'] ?></td>
                                                <td style="text-align:center;"><?= $c['comp'] ?></td>
                                                <td>
                                                    <div class="rsk-progress-bar">
                                                        <div class="rsk-progress-fill" style="width:<?= $pct ?>%;"></div>
                                                    </div>
                                                    <span
                                                        style="font-size:10px; color:#64748b; margin-left:4px;"><?= $pct ?>%</span>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        <tr style="border-top: 2px solid #e2e8f0;">
                                            <td style="font-weight:700; color:#0f172a;">Total</td>
                                            <td style="text-align:center; font-weight:700; color:#0f172a;"><?= $totTotal ?>
                                            </td>
                                            <td style="text-align:center; font-weight:700; color:#0f172a;"><?= $totPend ?>
                                            </td>
                                            <td style="text-align:center; font-weight:700; color:#0f172a;"><?= $totComp ?>
                                            </td>
                                            <td style="font-weight:700; color:#0f172a;">
                                                <?= $totTotal > 0 ? round(($totComp / $totTotal) * 100) : 0 ?>%</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="rsk-row-3">
                            <div class="rsk-panel">
                                <div class="rsk-panel-title">
                                    <span>Recent Projects</span>
                                    <a href="#projects" class="rsk-panel-link tab-trigger" data-target="projects">View All
                                        &rarr;</a>
                                </div>
                                <table class="rsk-table">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        if (empty($recentProjectsLimit)): ?>
                                            <tr>
                                                <td colspan="6" style="text-align:center; color:#94a3b8; padding:20px;">No
                                                    projects yet. Add your first project!</td>
                                            </tr>
                                        <?php else:
                                            foreach ($recentProjectsLimit as $i => $rp):
                                                $rpStatus = $rp['status'] ?? 'Active';
                                                $rpPillStyle = $statusPillMap[$rpStatus] ?? 'background:#f1f5f9; color:#475569;';
                                                $rpPipeline = $rp['pipeline_stage'] ?? $rpStatus;
                                                $rpDue = $rp['due_date'] ? date('d M Y', strtotime($rp['due_date'])) : '-';
                                                ?>
                                                <tr>
                                                    <td style="font-weight:600;">#<?= str_pad($rp['id'], 3, '0', STR_PAD_LEFT) ?>
                                                    </td>
                                                    <td><?= htmlspecialchars($rp['client_name'] ?? 'N/A') ?></td>
                                                    <td><?= htmlspecialchars($rp['service_type'] ?? '-') ?></td>
                                                    <td><?= htmlspecialchars($rp['name']) ?></td>
                                                    <td><span class="rsk-pill"
                                                            style="<?= $rpPillStyle ?>"><?= htmlspecialchars($rpPipeline) ?></span>
                                                    </td>
                                                    <td><i data-lucide="calendar"
                                                            style="width:10px; height:10px; display:inline-block;"></i>
                                                        <?= $rpDue ?></td>
                                                </tr>
                                            <?php endforeach; endif; ?>
                                    </tbody>
                                ...
                                <div style="display: flex; align-items: center; justify-content: center; height: 180px;">
                                    ...
                                    <div style="position: relative; width: 140px; height: 140px;">
                                        ...
                                        <div
                                            ...
                                            <span
                                                style="font-size: 20px; font-weight: 700; color: #0f172a;"><?= $rsk_totalProjects ?></span>
                                            <span style="font-size: 8px; color: #64748b;">Total Projects</span>
                                        </div>
                                    </div>
                                    <div style="margin-left: 20px; font-size: 10px;">
                                        <?php foreach (['Layout', 'Building', 'Single Plot', 'UAL', 'Land Survey'] as $sn):
                                            ...
                                            ?>
                                            <div
                                                style="display:flex; justify-content:space-between; margin-bottom:6px; width:160px;">
                                                <span style="color:#475569;"><span style="color:<?= $svColor ?>;">■</span>
                                                    <?= $sn ?></span> <span
                                                    style="font-weight:600; color:#0f172a;"><?= $sv['total'] ?>
                                                    (<?= $svPct ?>%)</span></div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                                <div style="font-size: 9px; color: #94a3b8; text-align: center; margin-top: 10px;">*
                                    Multiple NOCs may be applicable for a project</div>
                            </div>
                                    ...
                                    <?php if (empty($recentNotifications)): ?>
                                        <div style="text-align:center; padding: 20px; color:#64748b; font-size:11px;">
                                            <i data-lucide="bell-off"
                                                style="width:24px; height:24px; margin-bottom:8px; color:#94a3b8; display:inline-block;"></i>
                                            <div>No new notifications</div>
                                        </div>
                                    <?php else: ?>
                                        <?php foreach ($recentNotifications as $n):
                                            ...
                                            <div style="display:flex; align-items:flex-start; gap:10px;">
                                                <div
                                                    style="width:24px; height:24px; background:<?= $bg ?>; color:<?= $color ?>; border-radius:50%; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
                                                    <i data-lucide="<?= $icon ?>" style="width:12px; height:12px;"></i></div>
                                                <div style="flex:1;">
...
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
                                    ...
                                    <div style="margin-left: 20px; font-size: 11px;">
                                        <div
                                            style="display:flex; justify-content:space-between; margin-bottom:8px; width:130px;">
                                            <span style="color:#475569;"><span style="color:#10b981;">■</span>
                                                Completed</span> <span
                                                style="font-weight:600; color:#0f172a;"><?= $stCompleted ?>
                                                (<?= round($stCompleted / $stTotal * 100) ?>%)</span></div>
                                        <div
                                            style="display:flex; justify-content:space-between; margin-bottom:8px; width:130px;">
                                            <span style="color:#475569;"><span style="color:#3b82f6;">■</span> Active</span>
                                            <span style="font-weight:600; color:#0f172a;"><?= $stActive ?>
                                                (<?= round($stActive / $stTotal * 100) ?>%)</span></div>
                                        <div
                                            style="display:flex; justify-content:space-between; margin-bottom:8px; width:130px;">
                                            <span style="color:#475569;"><span style="color:#f59e0b;">■</span>
                                                Pending</span> <span
                                                style="font-weight:600; color:#0f172a;"><?= $stPending ?>
                                                (<?= round($stPending / $stTotal * 100) ?>%)</span></div>
                                        <div style="display:flex; justify-content:space-between; width:130px;"><span
                                                style="color:#475569;"><span style="color:#ef4444;">■</span> Rejected</span>
                                            <span style="font-weight:600; color:#0f172a;"><?= $stRejected ?>
                                                (<?= round($stRejected / $stTotal * 100) ?>%)</span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rsk-panel">
                                <div class="rsk-panel-title">
                                    <span>Top Services by Task Volume</span>
                                    <a href="#reports" class="rsk-panel-link tab-trigger" data-target="reports">View Report
                                        &rarr;</a>
                                </div>
                                <div style="height: 180px;">
                                    <canvas id="servicesChart"></canvas>
                            ...
                            <div class="rsk-panel">
                                ...
                                <div class="rsk-qa-grid" style="height: 180px; align-content: center;">
                                    <div class="rsk-qa-btn" data-action="new-project">
                                        <div class="rsk-qa-icon" style="color:#3b82f6;"><i data-lucide="plus-circle"></i>
                                        </div>
                                        <div class="rsk-qa-text">New Project</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="add-client">
                                        <div class="rsk-qa-icon" style="color:#10b981;"><i data-lucide="user-plus"></i>
                                        </div>
                                        <div class="rsk-qa-text">Add Client</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="new-survey">
                                        <div class="rsk-qa-icon" style="color:#f59e0b;"><i data-lucide="map"></i></div>
                                        <div class="rsk-qa-text">New Survey</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="upload-document">
                                        <div class="rsk-qa-icon" style="color:#a855f7;"><i data-lucide="upload-cloud"></i>
                                        </div>
                                        <div class="rsk-qa-text">Upload Document</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="noc-tracker">
                                        <div class="rsk-qa-icon" style="color:#22c55e;"><i data-lucide="check-shield"></i>
                                        </div>
                                        <div class="rsk-qa-text">NOC Tracker</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="payment-entry">
                                        <div class="rsk-qa-icon" style="color:#ec4899;"><i data-lucide="credit-card"></i>
                                        </div>
                                        <div class="rsk-qa-text">Payment Entry</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="task-manager">
                                        <div class="rsk-qa-icon" style="color:#3b82f6;"><i data-lucide="clipboard-list"></i>
                                        </div>
                                        <div class="rsk-qa-text">Task Manager</div>
                                    </div>
                                    <div class="rsk-qa-btn" data-action="reports">
                                        <div class="rsk-qa-icon" style="color:#f97316;"><i data-lucide="bar-chart-2"></i>
                                        </div>
                                        <div class="rsk-qa-text">Reports</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="stageModal"
                            ...
                            <div
                                style="background:#fff; border-radius:12px; width:90%; max-width:700px; max-height:85vh; display:flex; flex-direction:column; box-shadow:0 20px 60px rgba(0,0,0,0.3);">
                                <div
                                    style="display:flex; justify-content:space-between; align-items:center; padding:20px 24px; border-bottom:1px solid #e2e8f0;">
                                    <h3 id="stageModalTitle"
                                        style="margin:0; font-size:16px; font-weight:700; color:#0f172a;">Stage Projects
                                    </h3>
                                    <button onclick="closeStageModal()"
                                        style="border:none; background:none; cursor:pointer; font-size:20px; color:#64748b; line-height:1;">&times;</button>
                                </div>
                                <div style="padding:20px 24px; overflow-y:auto; flex:1;">
                                    <div id="stageModalLoader" style="text-align:center; padding:40px; color:#64748b;">
                                        <div style="font-size:24px; margin-bottom:10px;">⏳</div>Loading projects...
                                    ...
                                    <div id="stageModalContent" style="display:none;">
                                        <div id="stageModalSummary"
                                            style="display:flex; gap:16px; margin-bottom:20px; flex-wrap:wrap;"></div>
                                        <div id="stageProjectsList" style="display:flex; flex-direction:column; gap:14px;">
                                        </div>
                                    </div>
                                </div>
                                <?php if ($isCompleted): ?>
                    ...
                    <div id="view-layout" class="tab-view">
                        ...
                        <div class="section-card" style="padding: 24px;">
                            <h3
                                style="margin-bottom: 20px; font-size: 16px; color: #1e293b; border-bottom: 1px solid #e2e8f0; padding-bottom: 10px;">
                                Create Task Sequence</h3>
                            ...
                            <div style="display: flex; gap: 16px; align-items: flex-end; margin-bottom: 30px;">
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <input type="number" class="form-control" id="layout-num-tasks" min="1" max="50"
                                        value="5" style="width: 200px;">
                                </div>
                                <button class="btn btn-secondary" id="btn-generate-sequence"
                                    style="height: 38px; background: #e2e8f0; color: #0f172a;">Generate Inputs</button>
                            </div>

                            <div id="layout-sequence-container" style="display: none;">
                                <h4 style="margin-bottom: 15px; font-size: 14px; color: #475569;">Task Sequence Definition
                                </h4>
                                <div id="layout-tasks-wrapper"
                                ...
                                <div style="text-align: right; border-top: 1px solid #e2e8f0; padding-top: 15px;">
                                    <button class="btn btn-primary" id="btn-save-layout" style="padding: 8px 24px;">Save &
                    ...
                    <div id="view-tasks" class="tab-view">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                ...
                                <!-- Priority Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="tasks-priority-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="filter"></i> Priority <i data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="tasks-priority-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-priority-item" data-priority="All">All Priorities</a>
                                            <a href="#" class="filter-priority-item" data-priority="Low">Low</a>
                                            <a href="#" class="filter-priority-item" data-priority="Medium">Medium</a>
                                ...
                                <!-- Status Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="tasks-status-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;">Status <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="tasks-status-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-status-item" data-status="All">All Statuses</a>
                                            <a href="#" class="filter-status-item" data-status="Todo">Todo</a>
                                ...
                                <!-- Sort -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="tasks-sort-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="arrow-up-down"></i> Sort <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="tasks-sort-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="sort-tasks-item" data-sort="default">Default</a>
                                            <a href="#" class="sort-tasks-item" data-sort="due-asc">Due Date (Asc)</a>
                                            <a href="#" class="sort-tasks-item" data-sort="due-desc">Due Date (Desc)</a>
                                            <a href="#" class="sort-tasks-item" data-sort="priority-high">Priority: High to
                                                Low</a>
                                            <a href="#" class="sort-tasks-item" data-sort="priority-low">Priority: Low to
                                                High</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Date Type -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="tasks-date-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="calendar"></i> Date Type <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="tasks-date-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-tasks-date-item" data-date-range="All">All Time</a>
                                            <a href="#" class="filter-tasks-date-item" data-date-range="Today">Today</a>
                                            <a href="#" class="filter-tasks-date-item"
                                                data-date-range="Yesterday">Yesterday</a>
                                            <a href="#" class="filter-tasks-date-item" data-date-range="ThisWeek">This
                                                Week</a>
                                            <a href="#" class="filter-tasks-date-item" data-date-range="ThisMonth">This
                                                Month</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Add Task Button -->
                                <button class="btn btn-primary" id="btn-tasks-add-task"
                                    style="height: 32px; padding: 4px 14px; font-size: 11px; background-color: #2563eb;"><i
                                        data-lucide="plus"></i> Add Task</button>
                            </div>
                        </div>

                        <!-- Sub Navigation Tabs -->
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e2e8f0; margin-bottom: 15px; padding-bottom: 8px;">
                            <div style="display: flex; gap: 20px;" id="tasks-view-sub-tabs">
                                <span class="task-sub-tab active" data-sub-view="list"
                                    style="font-size: 13px; font-weight: 600; color: #2563eb; border-bottom: 2px solid #2563eb; padding-bottom: 8px; cursor: pointer; display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="align-left" style="width: 14px; height: 14px;"></i> List</span>
                                <span class="task-sub-tab" data-sub-view="kanban"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer; display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="columns" style="width: 14px; height: 14px;"></i> Kanban</span>
                                <span class="task-sub-tab" data-sub-view="calendar"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer; display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="calendar-days" style="width: 14px; height: 14px;"></i> Calendar</span>
                            </div>
                            <div style="display: flex; gap: 16px; font-size: 11px; font-weight: 600; color: #64748b;">
                                <span style="cursor: pointer;">Draft Tasks</span>
                                <span style="cursor: pointer; display: flex; align-items: center; gap: 4px;"><i
                                        data-lucide="layout-grid" style="width: 12px; height: 12px;"></i> Customize</span>
                                <span style="cursor: pointer;"><i data-lucide="more-horizontal"
                        ...
                        <div id="tasks-list-view" class="task-sub-view-container active">
                            <div class="section-card"
                                style="padding: 0; overflow: hidden; border-radius: 8px; border: 1px solid #e2e8f0; background: #ffffff;">
                                <!-- Table header block -->
                                <div
                                    style="display: flex; align-items: center; background-color: #f8fafc; border-bottom: 1px solid #cbd5e1; font-size: 11px; font-weight: 700; color: #475569; padding: 12px 16px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    <div style="flex: 2; text-align: left;">Task Name</div>
                                    <div style="flex: 1; text-align: left;">Created Date</div>
                                    <div style="flex: 1; text-align: left;">Due Date</div>
                                    <div style="flex: 1; text-align: left;">Priority</div>
                                ...
                                foreach ($groups as $grp):
                                    ...
                                    <div class="task-group-container">
                                        <div class="task-group-header" data-group-id="<?= $grp['id'] ?>">
                                            <i data-lucide="chevron-down" class="accordion-caret"
                                                style="width: 14px; height: 14px; color: #64748b; transition: transform 0.2s;"></i>
                                            <h4><?= $grp['title'] ?></h4>
                                        ...
                                        <div class="task-group-body" id="group-body-<?= $grp['id'] ?>">
                                            <?php if (empty($grp['tasks'])): ?>
                                                <div
                                                    style="padding: 16px; font-size: 12.5px; color: #94a3b8; text-align: center; background-color: #ffffff; border-bottom: 1px solid #f1f5f9;">
                                            ...
                                            <?php else: ?>
                                                <?php foreach ($grp['tasks'] as $t):
                                                    ...
                                                    <div class="task-row" data-task-id="<?= $t['id'] ?>"
                                                        ...
                                                        style="display: flex; align-items: center; padding: 12px 16px; border-bottom: 1px solid #f1f5f9; background-color: #ffffff; font-size: 13px; color: #334155;">
                                                        <div style="flex: 2; display: flex; flex-direction: column; text-align: left;">
                                                            <span
                                                                style="font-weight: 600; color: #1e293b;"><?= htmlspecialchars($t['title']) ?></span>
                                                            <small class="text-muted"
                                                                style="font-size: 11px; margin-top: 2px;"><?= htmlspecialchars($t['description']) ?></small>
                                                        </div>
                                                        <div style="flex: 1; text-align: left; font-size: 12.5px;">
                                                            <?= date('d M Y', strtotime($t['created_at'])) ?></div>
                                                        <div style="flex: 1; text-align: left; font-size: 12.5px;">
                                                            <?= $t['due_date'] ? date('d M Y', strtotime($t['due_date'])) : 'N/A' ?>
                                                        </div>
                                                        <div style="flex: 1; text-align: left;"><span
                                                                class="priority-tag <?= $pri ?>"><?= $t['priority'] ?></span></div>
                                                        <div
                                                            style="flex: 1; text-align: left; display: flex; align-items: center; justify-content: space-between;">
                                                            <span class="status-badge <?= $badge ?>"><?= $t['status'] ?></span>
                                                            <button class="btn-icon btn-edit-task" data-id="<?= $t['id'] ?>"
                                                                data-title="<?= htmlspecialchars($t['title'], ENT_QUOTES) ?>"
                                                                data-due="<?= $t['due_date'] ?>"
                                                                data-days="<?= $t['estimated_duration'] ?>"
                                                                style="background:none; border:none; cursor:pointer; padding:4px;"
                                                                title="Edit Task"><i data-lucide="edit-2"
                                                                    style="width:12px; height:12px; color:#64748b;"></i></button>
                                                        </div>
                                                    </div>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                        ...
                        <div id="tasks-kanban-view" class="task-sub-view-container" style="display: none;">
                            <div class="kanban-board-wrapper"
                                style="display: flex; gap: 16px; overflow-x: auto; padding-bottom: 15px;">
                        ...
                        <div id="tasks-calendar-view" class="task-sub-view-container" style="display: none;">
                            <div class="calendar-view-wrapper"
                                style="padding: 20px; border-radius: 8px; border: 1px solid #e2e8f0;">
                                <!-- Dynamically rendered by JS -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="view-projects" class="tab-view">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                ...
                                <!-- Priority Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="projects-priority-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="filter"></i> Priority <i data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="projects-priority-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-project-priority-item" data-priority="All">All
                                                Priorities</a>
                                            <a href="#" class="filter-project-priority-item" data-priority="Low">Low</a>
                                            <a href="#" class="filter-project-priority-item"
                                ...
                                <!-- Status Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="projects-status-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;">Status <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="projects-status-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-project-status-item" data-status="All">All
                                                Statuses</a>
                                            <a href="#" class="filter-project-status-item" data-status="Active">Active</a>
                                            <a href="#" class="filter-project-status-item"
                                ...
                                <!-- Sort -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="projects-sort-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="arrow-up-down"></i> Sort <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="projects-sort-dropdown"
                                        style="right: 0; min-width: 160px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="sort-projects-item" data-sort="default">Default</a>
                                            <a href="#" class="sort-projects-item" data-sort="name-asc">Project Name
                                                (A-Z)</a>
                                            <a href="#" class="sort-projects-item" data-sort="name-desc">Project Name
                                                (Z-A)</a>
                                            <a href="#" class="sort-projects-item" data-sort="created-newest">Newest
                                                Created</a>
                                            <a href="#" class="sort-projects-item" data-sort="created-oldest">Oldest
                                                Created</a>
                                            <a href="#" class="sort-projects-item" data-sort="completion-rate">Completion
                                                Rate</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Date Type -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="projects-date-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;"><i
                                            data-lucide="calendar"></i> Date Type <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="projects-date-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-projects-date-item" data-date-range="All">All Time</a>
                                            <a href="#" class="filter-projects-date-item" data-date-range="Today">Today</a>
                                            <a href="#" class="filter-projects-date-item"
                                                data-date-range="Yesterday">Yesterday</a>
                                            <a href="#" class="filter-projects-date-item" data-date-range="ThisWeek">This
                                                Week</a>
                                            <a href="#" class="filter-projects-date-item" data-date-range="ThisMonth">This
                                                Month</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Create Project Button -->
                                <button class="btn btn-primary" id="btn-projects-add-project"
                                    style="height: 32px; padding: 4px 14px; font-size: 11px; background-color: #2563eb;"><i
                                        data-lucide="plus"></i> Create Project</button>
                            </div>
                        </div>
                        ...
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e2e8f0; margin-bottom: 15px; padding-bottom: 8px;">
                            <div style="display: flex; gap: 20px;">
                                <span class="proj-tab-btn active"
                                    style="font-size: 13px; font-weight: 600; color: #2563eb; border-bottom: 2px solid #2563eb; padding-bottom: 8px; cursor: pointer;">Created
                                    By Me</span>
                                <span class="proj-tab-btn"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">My
                                    Team Project</span>
                            </div>
                        </div>
                        ...
                        <!-- Section: Favourites -->
                        <h3
                            style="font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #64748b; margin-bottom: 10px;">
                            Favourites</h3>
                        ...
                        <div class="project-cards-grid" id="projects-grid-container">
                            <?php foreach ($projects as $p):
                                ...
                                $updated_text = "Last updated: 1 day ago";
                                if ($p['id'] % 3 == 0)
                                    $updated_text = "Last updated: 3 days ago";
                                else if ($p['id'] % 2 == 0)
                                    $updated_text = "Last updated: 2 days ago";
                                ?>
                                <div class="project-grid-card"
                                    data-project-name="<?= htmlspecialchars(strtolower($p['name'])) ?>"
                                    data-status="<?= htmlspecialchars($p['status']) ?>"
                                    data-priority="<?= htmlspecialchars($p['priority']) ?>"
                                    data-created-at="<?= htmlspecialchars($p['created_at']) ?>"
                                    data-completion-rate="<?= $pct ?>"
                                    data-created-by="<?= htmlspecialchars($p['created_by'] ?? '') ?>"
                                    data-assigned-to="<?= htmlspecialchars($p['assigned_to'] ?? '') ?>"
                                    data-team-member-ids="<?= htmlspecialchars($p['member_ids'] ?? '') ?>">
                                    <div class="project-card-header">
                                        <div class="project-card-status-row">
                                            ...
                                            <span class="status-badge <?= $isCompleted ? 'completed' : 'process' ?>"
                                                style="font-size: 10.5px; padding: 2px 8px;"><?= htmlspecialchars($p['status']) ?></span>
                                        </div>
                                    ...
                                    <div class="project-card-description">
                                        <?= htmlspecialchars($p['description'] ?: 'No description provided.') ?></div>
                                    ...
                                    <div class="project-card-footer">
                                        <span style="font-size: 11px; font-weight: 600; color: #64748b;">Client: <strong
                                                style="color: #0f172a;"><?= htmlspecialchars($p['client_name'] ?: 'None') ?></strong></span>
                            ...
                            <div class="left-sidebar-pane">
                                <div class="discussion-sidebar-header">
                                    ...
                                    <div style="display: flex; gap: 8px;">
                                        <button class="header-btn" id="btn-new-discussion" title="New Group Chat"
                                            style="width: 28px; height: 28px; border: 1px solid var(--sidebar-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                data-lucide="users" style="width: 14px; height: 14px;"></i></button>
                                        <button class="header-btn" id="btn-new-direct-message" title="New Direct Message"
                                            style="width: 28px; height: 28px; border: 1px solid var(--sidebar-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                data-lucide="user-plus" style="width: 14px; height: 14px;"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="discussion-sidebar-search">
                                    <div class="standard-search-wrapper" style="width: 100%;">
                                        <i data-lucide="search"></i>
                                        <input type="text" id="chat-search" class="search-input"
                                            placeholder="Search chats..." style="background: #f8fafc;">
                                    </div>
                                </div>

                                <div class="chat-group-buttons">
                                    <button class="chat-group-btn active" data-chat-group="All">All</button>
                                    <button class="chat-group-btn" data-chat-group="General">General</button>
                                ...
                                <div class="chat-threads-list">
                                    <?php if (empty($discussionsList)): ?>
                                        <div style="text-align: center; color: var(--text-muted); padding: 20px; font-size: 13px;"
                                            id="chat-threads-empty-placeholder">No discussions found. Click "+" to start one.
                                        </div>
                                    <?php else: ?>
                                        <?php foreach ($discussionsList as $index => $d):
                                            ...
                                            // Color mapping
                                            $discColor = 'da-ha';
                                            if (strpos($d['title'], 'KILUATTI') !== false)
                                                $discColor = 'da-ki';
                                            if (strpos($d['title'], 'KIZHMATTAI') !== false)
                                                $discColor = 'da-er';
                                            if (strpos($d['title'], 'THELLAR') !== false)
                                                $discColor = 'da-tb';
                                            if (strpos($d['title'], 'AGARAKO') !== false)
                                                $discColor = 'da-ag';
                                            if (strpos($d['title'], 'PULAVAN') !== false)
                                                $discColor = 'da-pu';
                                            if (strpos($d['title'], 'KASTAM') !== false)
                                                $discColor = 'da-ka';
                                            ...
                                            <div class="chat-thread-item <?= $isActive ? 'active' : '' ?>"
                                                data-chat-id="<?= $d['id'] ?>" data-chat-type="<?= htmlspecialchars($d['chat_type'] ?? $d['type'] ?? 'General') ?>"
                                                data-chat-title="<?= htmlspecialchars($d['title']) ?>"
                                                data-chat-avatar="<?= $initials ?>" data-chat-color="<?= $discColor ?>"
                                                style="position: relative;">
                                                <div class="chat-thread-avatar <?= $discColor ?>"><?= $initials ?></div>
                                                <div class="chat-thread-info" style="flex: 1; min-width: 0;">
                                                    <div class="chat-thread-name-row">
                                                        <span class="chat-thread-name"><?= htmlspecialchars($d['title']) ?></span>
                                                        <span class="chat-thread-time"><?= htmlspecialchars($d['last_message_time'] ?? $d['date_logged'] ?? '') ?></span>
                                                    </div>
                                                    <span class="chat-thread-preview" style="display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                                        <?php
                                                            $lastMsg = $d['last_message'] ?? '';
                                                            if (!empty($lastMsg)) {
                                                                // If it's an encrypted JSON payload, show placeholder
                                                                if (substr($lastMsg, 0, 1) === '{') {
                                                                    echo '🔒 Encrypted message';
                                                                } else {
                                                                    echo htmlspecialchars(strlen($lastMsg) > 45 ? substr($lastMsg, 0, 45) . '...' : $lastMsg);
                                                                }
                                                            } else {
                                                                echo '<i style="color: var(--text-muted);">No messages yet</i>';
                                                            }
                                                        ?>
                                                    </span>
                                                </div>
                                                <button class="thread-delete-btn" title="Delete"
                                                    style="position:absolute; top:6px; right:6px; background:transparent; border:none; cursor:pointer; color:#ef4444; padding:3px; border-radius:4px; opacity:0; transition:opacity 0.2s; display:flex; align-items:center; justify-content:center;"
                            ...
                            <div class="right-content-pane">
                                ...
                                <div class="chat-window-header" style="display: none;">
                                    ...
                                    <div class="chat-window-actions" style="display: flex; align-items: center;">
                                        <button id="chat-header-members" title="Manage Members"
                                            style="background:transparent; border:none; cursor:pointer; color:var(--text-muted); display:flex; align-items:center; justify-content:center; margin-right:14px;"><i
                                                data-lucide="users" style="width: 16px; height: 16px;"></i></button>
                                        <i id="chat-call-audio-btn" data-lucide="phone" class="chat-header-actions"
                                            style="cursor: pointer; width: 16px; height: 16px;"
                                            onclick="if(window.currentActiveDiscussionId) window.vyalaCalls.startCall(window.currentActiveDiscussionId, 'audio')"></i>
                                        <i id="chat-call-video-btn" data-lucide="video" class="chat-header-actions"
                                            style="cursor: pointer; width: 16px; height: 16px; margin-left: 14px;"
                                            onclick="if(window.currentActiveDiscussionId) window.vyalaCalls.startCall(window.currentActiveDiscussionId, 'video')"></i>
                                        <i data-lucide="info" class="chat-header-actions"
                                            style="cursor: pointer; width: 16px; height: 16px; margin-left: 14px;"></i>
                                        <button id="chat-delete-btn" title="Delete Discussion"
                                            style="background:transparent; border:none; cursor:pointer; color:#ef4444; display:flex; align-items:center; justify-content:center; margin-left:14px;"><i
                                                data-lucide="trash-2" style="width: 16px; height: 16px;"></i></button>
                                        <button id="chat-close-btn" title="Close Chat"
                                            style="background:transparent; border:none; cursor:pointer; color:#ef4444; display:flex; align-items:center; justify-content:center; margin-left:14px;"><i
                                                data-lucide="x" style="width: 18px; height: 18px;"></i></button>
                                    </div>
                                </div>

                                <!-- Chat window messages -->
                                <div class="chat-window-messages chat-messages-container"
                                    style="display: flex; flex-direction: column;">
                                    <div style="text-align: center; color: var(--text-muted); padding: 40px; font-size: 13px;"
                                        id="chat-blank-placeholder">Select a discussion thread to start chatting.</div>
                                </div>

                                <!-- Chat window footer input -->
                                <div class="chat-window-footer" style="display: none;">
                                    <form id="form-chat-send" style="width: 100%; display: flex; margin: 0; padding: 0;"
                                        enctype="multipart/form-data">
                                        <div class="chat-input-wrapper"
                                            style="width: 100%; display: flex; align-items: center; gap: 8px;">
                                            <input type="file" id="chat-file-input" name="attachment"
                                                style="display: none;">
                                            <button type="button" class="chat-input-btn" id="btn-chat-attach"
                                            ...
                                            <button type="submit" class="chat-input-btn chat-send-btn" title="Send"
                                                style="border: none; cursor: pointer; display: flex; align-items: center; justify-content: center;"><i
                                                    data-lucide="send" style="width: 14px; height: 14px;"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="pane-split-layout">
                            ...
                            <div class="left-sidebar-pane">
                                ...
                                <div class="documents-sidebar-menu">
                                    <a href="#" class="documents-menu-item active" data-doc-cat="all"><i
                                            data-lucide="folder"></i> All Files</a>
                                    <a href="#" class="documents-menu-item" data-doc-cat="drawing"><i
                                            data-lucide="file"></i> CAD Drawings</a>
                                    <a href="#" class="documents-menu-item" data-doc-cat="pdf"><i
                                            data-lucide="file-text"></i> PDF Documents</a>
                                    <a href="#" class="documents-menu-item" data-doc-cat="image"><i data-lucide="image"></i>
                                        Images</a>
                                    <a href="#" class="documents-menu-item" data-doc-cat="other"><i
                                            data-lucide="paperclip"></i> Other Files</a>
                                </div>
                                ...
                                <div class="storage-card-widget">
                                    ...
                                    <div class="storage-progress-bar-bg">
                                        <div class="storage-progress-bar-fill" style="width: <?= $storageProgressPct ?>%;">
                                        </div>
                                    </div>
                            ...
                            <div class="right-content-pane">
                                <!-- Header actions -->
                                <div
                                    style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid #f1f5f9; padding-bottom: 15px;">
                                    <h3 style="font-size: 16px; font-weight: 700; color: #0f172a; margin: 0;">Documents</h3>
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        <div class="standard-search-wrapper">
                                            <i data-lucide="search"></i>
                                            <input type="text" id="docs-search" class="search-input"
                                                placeholder="Search documents...">
                                        </div>
                                        <!-- Add New Document Button -->
                                        <button class="btn btn-primary" id="btn-docs-add"
                                            style="height: 32px; padding: 4px 14px; font-size: 11px; background-color: #2563eb;"><i
                                                data-lucide="plus"></i> Add New</button>
                                    </div>
                                </div>
                                ...
                                <div style="flex: 1; overflow-y: auto;">
                                    ...
                                    <div class="folders-grid">
                                        ...
                                        foreach ($projects as $p):
                                            ...
                                            <div class="folder-card">
                                                <div class="folder-icon"><i data-lucide="folder"
                                                        style="width: 24px; height: 24px; fill: #fbbf24;"></i></div>
                                                <div class="folder-info">
                                                    <span class="folder-name"
                                                        title="<?= htmlspecialchars($p['name']) ?>"><?= htmlspecialchars($p['name']) ?></span>
                                    ...
                                    <div class="table-responsive" style="margin-bottom:0;">
                                        <table class="table-custom">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr id="doc-empty-row"
                                                    style="display: <?= empty($realDocs) ? '' : 'none' ?>;">
                                                    <td colspan="5"
                                                ...
                                                <?php if (!empty($realDocs)): ?>
                                                    <?php foreach ($realDocs as $doc):
                                                        ...
                                                        <tr class="document-row"
                                                            data-doc-name="<?= htmlspecialchars(strtolower($doc['name'])) ?>"
                                                            data-doc-cat="<?= $docCat ?>">
                                                            <td style="text-align: left;">
                                                                <div style="display: flex; align-items: center; gap: 8px;">
                                                                    <i data-lucide="<?= $icon ?>"
                                                                        style="width: 18px; height: 18px; color: <?= $color ?>;"></i>
                                                                    <strong
                                                                        style="color: #0f172a; font-size: 12.5px;"><?= htmlspecialchars($doc['name']) ?></strong>
                                                                </div>
                                                            </td>
                                                            <td
                                                                style="text-align: left; font-size: 12.5px; font-weight: 500; color: #334155;">
                                                                <?= htmlspecialchars($doc['owner_name']) ?></td>
                                                            <td
                                                                style="text-align: left; font-size: 12.5px; color: var(--text-muted);">
                                                                <?= date('d M Y', strtotime($doc['created_at'])) ?></td>
                                                            <td
                                                                style="text-align: left; font-size: 12.5px; color: var(--text-muted);">
                                                                <?= htmlspecialchars($doc['size']) ?></td>
                                                            <td>
                                                                <div style="display: flex; justify-content: center; gap: 8px;">
                                                                    <button class="header-btn btn-doc-preview"
                                                                        data-doc-name="<?= htmlspecialchars($doc['name']) ?>"
                                                                        data-doc-path="<?= htmlspecialchars($doc['filepath']) ?>"
                                                                        title="Preview"
                                                                        style="width: 26px; height: 26px; border: 1px solid var(--sidebar-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                                            data-lucide="eye"
                                                                            style="width: 12px; height: 12px;"></i></button>
                                                                    <a href="<?= htmlspecialchars($doc['filepath']) ?>"
                                                                        download="<?= htmlspecialchars($doc['name']) ?>"
                                                                        class="header-btn" title="Download"
                                                                        style="width: 26px; height: 26px; border: 1px solid var(--sidebar-border); border-radius: 50%; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                                            data-lucide="download"
                                                                            style="width: 12px; height: 12px;"></i></a>
                                                                    <button class="header-btn btn-doc-delete"
                                    ...
                                    <div id="doc-pagination-container"
                                        style="display:flex; justify-content:space-between; align-items:center; padding:12px 16px; border-top:1px solid #f1f5f9; background:#fff; margin-top: 15px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0; border-top: none;">
                                        <span id="doc-pagination-info"
                                            style="font-size:12px; color:var(--text-muted);">Showing 1-5 of 0 files</span>
                                        <div style="display:flex; gap:8px;">
                                            <button class="btn btn-secondary" id="btn-doc-prev"
                                                style="height:28px; padding:2px 8px; font-size:11px;">Prev</button>
                                            <button class="btn btn-secondary" id="btn-doc-next"
                                                style="height:28px; padding:2px 8px; font-size:11px;">Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="view-notes" class="tab-view">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                ...
                                <!-- Tags Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="notes-tags-filter-toggle"
                                        style="height: 32px; padding: 4px 10px; font-size: 11px;">Tags <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="notes-tags-filter-dropdown"
                                        style="right: 0; min-width: 140px; display: none; position: absolute; z-index: 100;">
                                ...
                                <!-- Create Note Button -->
                                <button class="btn btn-primary" id="btn-notes-add-note"
                                    style="height: 32px; padding: 4px 14px; font-size: 11px; background-color: #2563eb;"><i
                                        data-lucide="plus"></i> Add Note</button>
                            </div>
                        </div>

                        <!-- Sub Navigation Tabs -->
                        <div
                            style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #e2e8f0; margin-bottom: 20px; padding-bottom: 8px;">
                            <div style="display: flex; gap: 20px;" id="notes-view-tabs">
                                <span class="note-tab-btn active" data-note-tab="all"
                                    style="font-size: 13px; font-weight: 600; color: #2563eb; border-bottom: 2px solid #2563eb; padding-bottom: 8px; cursor: pointer;">ALL</span>
                                <span class="note-tab-btn" data-note-tab="personal"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">PERSONAL</span>
                                <span class="note-tab-btn" data-note-tab="work"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">WORK</span>
                                <span class="note-tab-btn" data-note-tab="archive"
                                    style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">ARCHIVE</span>
                            </div>
                        </div>
                        ...
                        <div class="notes-cards-grid" id="notes-grid-container">
                            <?php if (empty($pinNotes)): ?>
                                <div style="grid-column: 1 / -1; text-align: center; color: var(--text-muted); padding: 40px;">
                                    No notes found. Click "Add Note" to create one.</div>
                            <?php else: ?>
                                <?php foreach ($pinNotes as $note):
                                    ...
                                    ?>
                                    <div class="note-sticky-card" data-note-id="<?= $note['id'] ?>"
                                        data-category="<?= htmlspecialchars(strtolower($note['category'])) ?>"
                                        data-title="<?= htmlspecialchars(strtolower($note['title'])) ?>"
                                        data-content="<?= htmlspecialchars(strtolower($note['content'])) ?>"
                                        data-tags="<?= htmlspecialchars(strtolower($note['tags'] ?? '')) ?>">
                                        <div class="note-sticky-header">
                                            <h4 class="note-sticky-title"><?= htmlspecialchars($note['title']) ?></h4>
                                            <button class="note-pin-btn" title="Pin Note"><i data-lucide="pin"
                                                    style="fill: #78350f; color: #78350f;"></i></button>
                                        </div>
                                        <div class="note-sticky-content"><?= nl2br(htmlspecialchars($note['content'])) ?></div>
                                        <?php if (!empty($note['tags'])): ?>
                                            <div class="note-card-tags-row"
                                                ...
                                                foreach ($tagsArr as $tg):
                                                    ...
                                                    if ($tg !== ''):
                                                        ...
                                                        <span class="note-tag-pill"
                                                            style="font-size: 9px; font-weight: 600; padding: 2px 6px; border-radius: 4px; background: #e0f2fe; color: #0369a1;"><?= htmlspecialchars($tg) ?></span>
                                                    <?php
                                                    endif;
                                                endforeach;
                                                ?>
                    ...
                    <div id="view-attendance" class="tab-view">
                        ...
                        <div
                            ...
                            <div style="display:flex; gap:10px; align-items:center; flex-wrap: wrap;">
                                ...
                                <div class="standard-search-wrapper">
                                    <i data-lucide="search"></i>
                                    <input type="text" id="attendance-search" class="search-input"
                                        placeholder="Search attendance...">
                                </div>
                                <!-- Employee Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="attendance-emp-filter-toggle"
                                        style="height:32px; padding:4px 12px; font-size:11px;"><i data-lucide="users"></i>
                                        Employee <i data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="attendance-emp-filter-dropdown"
                                        style="right:0; min-width:160px; display:none; position:absolute; z-index:100;">
                                        <div class="filter-dropdown-content" id="attendance-emp-filter-list">
                                            ...
                                            <?php foreach ($dropdownEmployees as $emp): ?>
                                                <a href="#" class="filter-attendance-emp-item"
                                                    data-emp="<?= htmlspecialchars($emp['name']) ?>"><?= htmlspecialchars($emp['name']) ?></a>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                                </div>
                                <!-- Status Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="attendance-status-filter-toggle"
                                        style="height:32px; padding:4px 12px; font-size:11px;">Status <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="attendance-status-filter-dropdown"
                                        style="right:0; min-width:140px; display:none; position:absolute; z-index:100;">
                                        <div class="filter-dropdown-content">
                                            <a href="#" class="filter-attendance-status-item" data-status="All">All
                                                Statuses</a>
                                            <a href="#" class="filter-attendance-status-item"
                                                data-status="Present">Present</a>
                                            <a href="#" class="filter-attendance-status-item"
                                                data-status="Absent">Absent</a>
                                ...
                                if (!$myAtt):
                                    ?>
                                    <button class="btn btn-primary" id="btn-attendance-checkin"
                                        style="height:32px; padding:4px 14px; font-size:11px; background:#10b981;"><i
                                            data-lucide="log-in"></i> Check In</button>
                                <?php elseif ($myAtt && $myAtt['check_out'] === null): ?>
                                    <button class="btn btn-primary" id="btn-attendance-checkout"
                                        style="height:32px; padding:4px 14px; font-size:11px; background:#ef4444;"><i
                                            data-lucide="log-out"></i> Check Out</button>
                                <?php else: ?>
                                    <span
                                        style="font-size: 11px; font-weight: 600; color: #10b981; border: 1px solid #10b981; padding: 4px 10px; border-radius: 6px; display: flex; align-items: center; gap: 4px;"><i
                                            data-lucide="check-circle" style="width:12px; height:12px;"></i> Done Today</span>
                                <?php endif; ?>
                                <!-- Date Range Filter -->
                                <div class="filter-dropdown-wrapper" style="position: relative; display: inline-block;">
                                    <button class="btn btn-secondary" id="attendance-date-filter-toggle"
                                        style="height:32px; padding:4px 12px; font-size:11px;"><i
                                            data-lucide="calendar"></i> This Month <i
                                            data-lucide="chevron-down"></i></button>
                                    <div class="filter-dropdown-menu" id="attendance-date-filter-dropdown"
                                        style="right:0; min-width:140px; display:none; position:absolute; z-index:100;">
                                        <div class="filter-dropdown-content">
                                            ...
                                            <a href="#" class="filter-attendance-date-item" data-range="ThisWeek">This
                                                Week</a>
                                            <a href="#" class="filter-attendance-date-item" data-range="ThisMonth">This
                                                Month</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- Export Button -->
                                <button class="btn btn-primary" id="btn-attendance-export"
                                    style="height:32px; padding:4px 14px; font-size:11px; background:#2563eb;"><i
                        ...
                        <div style="display:grid; grid-template-columns:repeat(4,1fr); gap:16px; margin-bottom:20px;">
                            <div class="stat-card c-projects">
                                <div class="stat-header">
                                    <div class="stat-icon-wrapper"><i data-lucide="check-circle"></i></div><span
                                        class="stat-title">Present Today</span>
                                </div>
                                <div class="stat-body">
                                    <h3 class="stat-value" id="att-stat-present"><?= $presentToday ?></h3>
                                </div>
                            </div>
                            <div class="stat-card c-pending">
                                <div class="stat-header">
                                    <div class="stat-icon-wrapper"><i data-lucide="x-circle"></i></div><span
                                        class="stat-title">Absent Today</span>
                                </div>
                                <div class="stat-body">
                                    <h3 class="stat-value" id="att-stat-absent"><?= $absentToday ?></h3>
                                </div>
                            </div>
                            <div class="stat-card c-approved">
                                <div class="stat-header">
                                    <div class="stat-icon-wrapper"><i data-lucide="clock"></i></div><span
                                        class="stat-title">Late Check-Ins</span>
                                </div>
                                <div class="stat-body">
                                    <h3 class="stat-value" id="att-stat-late"><?= $lateToday ?></h3>
                                </div>
                            </div>
                            <div class="stat-card c-rejected">
                                <div class="stat-header">
                                    <div class="stat-icon-wrapper"><i data-lucide="calendar-off"></i></div><span
                                        class="stat-title">Leaves This Month</span>
                                </div>
                                <div class="stat-body">
                                    <h3 class="stat-value" id="att-stat-leaves"><?= $leavesThisMonth ?></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-card" style="padding:0; overflow:hidden;">
                            <div
                                style="display:flex; align-items:center; background:#f8fafc; border-bottom:1px solid #e5e7eb; font-size:11px; font-weight:700; color:#475569; padding:12px 16px; text-transform:uppercase; letter-spacing:0.5px;">
                            ...
                            <?php else: ?>
                                <?php foreach ($attDbRows as $r):
                                    ...
                                    ?>
                                    <div class="attendance-row" data-emp-name="<?= htmlspecialchars($r['name']) ?>"
                                        data-date="<?= $r['date'] ?>" data-status="<?= htmlspecialchars($r['status']) ?>"
                                        data-check-in="<?= $inTime ?>" data-check-out="<?= $outTime ?>" data-hours="<?= $hrs ?>"
                                        style="display:flex; align-items:center; padding:12px 16px; border-bottom:1px solid #f1f5f9; font-size:13px;">
                                        <div style="flex:1.5; display:flex; align-items:center; gap:10px;">
                                            <div class="avatar-initials"
                                                style="background:#2563eb; color:#fff; width:30px; height:30px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:700;">
                                                <?= htmlspecialchars($initials) ?></div>
                                            <span style="font-weight:600; color:#0f172a;"><?= htmlspecialchars($r['name']) ?></span>
                                        </div>
                                        <div style="flex:1; color:#64748b; font-size:12.5px;">
                                            <?= date('d M Y', strtotime($r['date'])) ?></div>
                                        ...
                                        <div style="flex:1;"><span
                                                class="status-badge <?= $sc ?>"><?= htmlspecialchars($r['status']) ?></span></div>
                                    </div>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </div>
                    ...
                    <div id="view-reports" class="tab-view">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                            ...
                            <button class="btn btn-primary" onclick="window.print();"
                                style="height:32px; padding:4px 14px; font-size:11px; background:#2563eb;"><i
                                    data-lucide="download"></i> Export Report</button>
                        </div>

                        <?php if ($totalTasks === 0 && count($projects) === 0): ?>
                            <div class="section-card"
                                style="text-align: center; color: var(--text-muted); padding: 80px 20px; margin-bottom: 20px; font-size: 14px;">
                                <i data-lucide="bar-chart-2"
                                    style="width: 36px; height: 36px; color: var(--text-muted); margin-bottom: 8px; stroke-width: 1.5;"></i>
                        ...
                        <?php else: ?>
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:20px;">
                                ...
                                <div class="section-card">
                                    <div class="card-header" style="border-bottom:none; padding-bottom:0; margin-bottom:0;">
                                        ...
                                        <select class="filter-select">
                                            <option>All Projects</option><?php foreach ($dropdownProjects as $p): ?>
                                                <option><?= htmlspecialchars($p['name']) ?></option><?php endforeach; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="section-card">
                                    ...
                                    <div
                                        style="height:200px; position:relative; display:flex; align-items:center; justify-content:center; margin-top:12px;">
                                        <canvas id="reportPieChart"></canvas>
                                    </div>
                                    <div
                                        style="display:flex; justify-content:center; gap:16px; font-size:11px; font-weight:700; margin-top:10px;">
                            ...
                            <div class="section-card" style="padding:0; overflow:hidden;">
                                <div
                                    style="padding:14px 16px; border-bottom:1px solid #e5e7eb; font-size:14px; font-weight:700; color:#0f172a;">
                                    Team Performance Summary</div>
                                <div
                                    style="display:flex; align-items:center; background:#f8fafc; border-bottom:1px solid #e5e7eb; font-size:11px; font-weight:700; color:#475569; padding:10px 16px; text-transform:uppercase;">
                                    <div style="flex:2">Employee</div>
                                    <div style="flex:1">Assigned</div>
                                ...
                                if (empty($employeesList)):
                                    ...
                                    foreach ($employeesList as $emp):
                                        ...
                                        ?>
                                        <div
                                            style="display:flex; align-items:center; padding:11px 16px; border-bottom:1px solid #f1f5f9; font-size:13px;">
                                            <div style="flex:2; display:flex; align-items:center; gap:8px;">
                                                <div
                                                    style="background:#2563eb;color:#fff;width:28px;height:28px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;">
                                                    <?= htmlspecialchars($emp['avatar'] ?: substr($emp['name'], 0, 2)) ?></div>
                                                <span
                                                    style="font-weight:600;color:#0f172a;"><?= htmlspecialchars($emp['name']) ?></span>
                                            </div>
                                            ...
                                            <div style="flex:1;">
                                                <div style="display:flex;align-items:center;gap:8px;">
                                                    <div style="flex:1;height:6px;background:#e5e7eb;border-radius:3px;">
                                                        <div
                                                            style="height:6px;width:<?= $rate ?>%;background:#2563eb;border-radius:3px;">
                                                        </div>
                                                    </div>
                    ...
                    <div id="view-organizations" class="tab-view active">
                        <div class="section-card">
                            <div class="card-header"
                                style="border-bottom: none; margin-bottom: 0; display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <h3>Organizations</h3>
                                    <p class="text-muted"
                                        style="margin-top: 4px; font-size: 12px; text-transform: none; letter-spacing: normal;">
                                        Review and manage company organizations registered on the platform.</p>
                                </div>
...
=======
                            <?php if (!empty($pendingOrgs)): ?>
                                <div style="margin-top: 24px; margin-bottom: 8px;">
                                    <h4
                                        style="font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #f59e0b; margin-bottom: 12px;">
                                        ⏳ Pending Approval (<?= count($pendingOrgs) ?>)
                                    </h4>
                                    <div class="table-responsive" style="margin-bottom: 0;">
                                        <table class="table-custom" style="width: 100%;">
                                                ...
                                                <?php foreach ($pendingOrgs as $org): ?>
                                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                                        <td style="padding: 12px 16px;">
                                                            <div style="display: flex; align-items: center; gap: 10px;">
                                                                <div
                                                                    style="width: 36px; height: 36px; border-radius: 8px; background: linear-gradient(135deg, #f59e0b, #d97706); display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 14px; flex-shrink: 0;">
                                                                    <?= strtoupper(substr($org['name'], 0, 2)) ?>
                                                                </div>
                                                                <div>
                                                                    <div
                                                                        style="font-size: 13.5px; font-weight: 700; color: #0f172a;">
                                                                        <?= htmlspecialchars($org['name']) ?></div>
                                                                    <div style="font-size: 11.5px; color: #64748b;">
                                                                        <?= htmlspecialchars($org['slug'] ?: '-') ?></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td
                                                            style="padding: 12px 16px; text-align: center; font-size: 13px; font-weight: 700; color: #2563eb;">
                                                            <?= $org['emp_count'] ?></td>
                                                        <td
                                                            style="padding: 12px 16px; text-align: center; font-size: 13px; font-weight: 700; color: #7c3aed;">
                                                            <?= $org['proj_count'] ?></td>
                                                        <td style="padding: 12px 16px; font-size: 12.5px; color: #64748b;">
                                                            <?= date('d M Y', strtotime($org['created_at'])) ?></td>
                                                        <td style="padding: 12px 16px; text-align: center;">
...
=======
                            <div style="margin-top: 24px;">
                                <h4
                                    style="font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #10b981; margin-bottom: 12px;">
                                    ✅ Active Organizations (<?= count($activeOrgs) ?>)
                                </h4>
                                <?php if (empty($activeOrgs)): ?>
                                    <div style="text-align: center; color: var(--text-muted); padding: 40px; font-size: 14px;">
                                        No active organizations yet.</div>
                                <?php else: ?>
                                    <div class="table-responsive" style="margin-bottom: 0;">
                                        <table class="table-custom" style="width: 100%;">
                                            <thead>
                                                ...
                                                <?php foreach ($activeOrgs as $org): ?>
                                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                                        <td style="padding: 12px 16px;">
                                                            <div style="display: flex; align-items: center; gap: 10px;">
                                                                <div
                                                                    style="width: 36px; height: 36px; border-radius: 8px; background: linear-gradient(135deg, #2563eb, #1d4ed8); display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 14px; flex-shrink: 0;">
                                                                    <?= strtoupper(substr($org['name'], 0, 2)) ?>
                                                                </div>
                                                                <span
                                                                    style="font-size: 13.5px; font-weight: 700; color: #0f172a;"><?= htmlspecialchars($org['name']) ?></span>
                                                            </div>
                                                        </td>
                                                        <td
                                                            style="padding: 12px 16px; text-align: center; font-size: 13px; font-weight: 700; color: #2563eb;">
                                                        ...
                                                        <td style="padding: 12px 16px; text-align: center;">
                                                            <span
                                                                style="display: inline-flex; align-items: center; gap: 5px; font-size: 10.5px; font-weight: 700; color: #065f46; background: #dcfce7; padding: 3px 10px; border-radius: 20px; border: 1px solid #bbf7d0;">
                                                                <span
                                                                    style="width: 6px; height: 6px; border-radius: 50%; background: #10b981;"></span>Active
                                                            </span>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
...
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
                            ...
                            <?php if (!empty($rejectedOrgs)): ?>
                                <div style="margin-top: 24px;">
                                    <h4
                                        style="font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; color: #ef4444; margin-bottom: 12px;">
                                        ✗ Rejected (<?= count($rejectedOrgs) ?>)
                                    </h4>
                                    <div class="table-responsive" style="margin-bottom: 0;">
                                        <table class="table-custom" style="width: 100%;">
                                            ...
                                            <tbody>
                                                <?php foreach ($rejectedOrgs as $org): ?>
                                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                                        <td
                                                            style="padding: 12px 16px; font-size: 13.5px; font-weight: 600; color: #94a3b8;">
                                                            <?= htmlspecialchars($org['name']) ?></td>
                                                        <td style="padding: 12px 16px; font-size: 12.5px; color: #94a3b8;">
                                                            <?= date('d M Y', strtotime($org['created_at'])) ?></td>
                                                        <td style="padding: 12px 16px; text-align: center;">
                                                            <span
                                                                style="font-size: 10.5px; font-weight: 700; color: #991b1b; background: #fee2e2; padding: 3px 10px; border-radius: 20px; border: 1px solid #fecaca;">Rejected</span>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                    ...
                    <div class="section-card">
                        <div class="card-header"
                            ...
                            <div>
                                ...
                                <p class="text-muted"
                                    style="margin-top: 4px; font-size: 12px; text-transform: none; letter-spacing: normal;">
                                    Manage registered user accounts and their access status.</p>
                            </div>
                        ...
                        <div style="display: flex; gap: 12px; margin-top: 20px; margin-bottom: 24px; flex-wrap: wrap;">
                            <div
                                style="display: flex; align-items: center; gap: 8px; background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 10px 16px; flex: 1; min-width: 100px;">
                                <div style="width: 8px; height: 8px; border-radius: 50%; background: #10b981;"></div>
                                <span style="font-size: 13px; font-weight: 700; color: #065f46;"><?= $activeCount ?>
                                    Active</span>
                            </div>
                            <div
                                style="display: flex; align-items: center; gap: 8px; background: #fffbeb; border: 1px solid #fde68a; border-radius: 8px; padding: 10px 16px; flex: 1; min-width: 100px;">
                                <div style="width: 8px; height: 8px; border-radius: 50%; background: #f59e0b;"></div>
                                <span style="font-size: 13px; font-weight: 700; color: #92400e;"><?= $pendingCount ?>
                                    Pending</span>
                            </div>
                            <div
                                style="display: flex; align-items: center; gap: 8px; background: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 10px 16px; flex: 1; min-width: 100px;">
                                <div style="width: 8px; height: 8px; border-radius: 50%; background: #ef4444;"></div>
                                <span
                                    style="font-size: 13px; font-weight: 700; color: #991b1b;"><?= $deactivatedCount ?>
                                    Deactivated</span>
                            </div>
                            <div
                                style="display: flex; align-items: center; gap: 8px; background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 8px; padding: 10px 16px; flex: 1; min-width: 100px;">
                                <i data-lucide="users" style="width: 14px; height: 14px; color: #2563eb;"></i>
                                <span style="font-size: 13px; font-weight: 700; color: #1e40af;"><?= count($allUsers) ?>
                                    Total</span>
                            </div>
                        </div>
                        ...
                        <?php if (empty($allUsers)): ?>
                            <div style="text-align: center; color: var(--text-muted); padding: 60px 20px; font-size: 14px;">
                                <i data-lucide="users"
                                    style="width: 40px; height: 40px; stroke-width: 1.5; display: block; margin: 0 auto 12px auto;"></i>
                                ...
                                <table class="table-custom" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center; padding: 10px 16px;">Status</th>
                                            <th style="text-align: center; padding: 10px 16px;">Message</th>
                                            <?php if ($jwtPayload['role'] === 'Admin' || $jwtPayload['role'] === 'Project Lead'): ?>
                                                <th style="text-align: center; padding: 10px 16px;">Actions</th>
                                            <?php endif; ?>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php foreach ($allUsers as $usr):
                                            ...
                                            ?>
                                            <tr class="user-row" data-user-id="<?= $usr['id'] ?>"
                                                style="border-bottom: 1px solid #f1f5f9;">
                                                <td style="padding: 12px 16px;">
                                                    <div style="display: flex; align-items: center; gap: 10px;">
                                                        <div
                                                            style="background: <?= $avatarBg ?>; color: #fff; width: 36px; height: 36px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 13px; flex-shrink: 0;">
                                                            <?= htmlspecialchars($initials) ?>
                                                        </div>
                                                        <span class="user-name-span"
                                                            style="font-size: 13.5px; font-weight: 600; color: #0f172a;"><?= htmlspecialchars($usr['name']) ?></span>
                                                    </div>
                                                </td>
                                                <td
                                                    style="padding: 12px 16px; font-size: 12.5px; color: #64748b; font-weight: 500;">
                                                    <?= htmlspecialchars($usr['role']) ?></td>
                                                <td style="padding: 12px 16px; font-size: 12.5px; color: #475569;">
                                                    <?= htmlspecialchars($usr['email']) ?></td>
                                                <td
                                                    style="padding: 12px 16px; font-size: 12px; color: #64748b; font-family: monospace;">
                                                    <?= htmlspecialchars($usr['emp_code'] ?: '-') ?></td>
                                                <td class="user-status-cell" style="padding: 12px 16px; text-align: center;">
                                                    ...
                                                    <?php elseif ($isDeactivated): ?>
                                                        <span
                                                            style="display: inline-flex; align-items: center; gap: 5px; font-size: 10.5px; font-weight: 700; color: #991b1b; background: #fee2e2; padding: 3px 10px; border-radius: 20px; border: 1px solid #fecaca;">
                                                            <span
                                                                style="width: 6px; height: 6px; border-radius: 50%; background: #ef4444;"></span>Deactivated
                                                        </span>
                                                    <?php else: ?>
                                                        <span
                                                            style="display: inline-flex; align-items: center; gap: 5px; font-size: 10.5px; font-weight: 700; color: #92400e; background: #fef3c7; padding: 3px 10px; border-radius: 20px; border: 1px solid #fde68a;">
                                                            <span
                                                                style="width: 6px; height: 6px; border-radius: 50%; background: #f59e0b;"></span>Pending
                                                        </span>
                                                    <?php endif; ?>
                                                </td>
                                                <td style="padding: 12px 16px; text-align: center;">
                                                    <button class="btn-direct-message-user" data-user-id="<?= $usr['id'] ?>" style="height: 28px; padding: 0 10px; font-size: 11px; font-weight: 600; background: #e0e7ff; color: #4338ca; border: 1px solid #c7d2fe; border-radius: 6px; cursor: pointer; display: inline-flex; align-items: center; gap: 4px;">
                                                    ...
                                                    <td class="user-actions-cell" style="padding: 12px 16px; text-align: center;">
                                                        <div style="display: flex; gap: 6px; justify-content: center;">
                                                            <?php if ($isPending): ?>
                                                                ...
                                                                <button class="btn-user-deactivate" data-emp-id="<?= $usr['id'] ?>"
                                                                    data-current-status="<?= $usrStatus ?>"
                                                            ...
                                                            <?php else: ?>
                                                                <button class="btn-user-activate" data-emp-id="<?= $usr['id'] ?>"
                                                                    data-current-status="<?= $usrStatus ?>"
                                                            ...
                                                            <?php endif; ?>
                                                            <button class="btn-delete-emp" data-emp-id="<?= $usr['id'] ?>"
                                                                data-emp-name="<?= htmlspecialchars($usr['name']) ?>"
                                                                style="width: 28px; height: 28px; background: #f8fafc; color: #94a3b8; border: 1px solid #e2e8f0; border-radius: 6px; cursor: pointer; display: flex; align-items: center; justify-content: center;"
                                                                title="Delete User">
                ...
                <?php if ($jwtPayload['role'] !== 'Admin'): ?>
                    <div id="view-departments" class="tab-view">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                            ...
                            <button class="btn btn-primary" id="btn-add-department"
                                style="height:32px; padding:4px 14px; font-size:11px; background:#2563eb;"><i
                                    data-lucide="plus"></i> Add Department</button>
                        </div>
                        <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:20px;"
                            id="departments-grid-container">
                            <?php
                            if (empty($departmentsList)):
                                ?>
                                <div style="grid-column: 1 / -1; text-align: center; color: var(--text-muted); padding: 40px;"
                                    id="departments-empty-placeholder">No departments registered yet. Click "Add Department" to
                                    start.</div>
                                <?php
                            else:
                                foreach ($departmentsList as $d):
                                    ...
                                    <div class="section-card"
                                        ...
                                        <div style="display:flex; align-items:center; gap:16px;">
                                            <div
                                                style="width:48px;height:48px;border-radius:12px;background:<?= $bg ?>;color:<?= $color ?>;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                                <i data-lucide="<?= $icon ?>" style="width:22px;height:22px;"></i>
                                            </div>
                                            <div>
                                                <div style="font-size:15px;font-weight:700;color:#0f172a;">
                                                    <?= htmlspecialchars($d['name']) ?></div>
                                                <div style="font-size:12px;color:#6b7280;margin-top:3px;"><?= $empCount ?>
                                                    employee<?= $empCount != 1 ? 's' : '' ?></div>
                                            </div>
                                        </div>
                                        <div style="display:flex; gap:8px;">
                                            <button class="header-btn btn-dept-edit" data-dept-id="<?= $d['id'] ?>"
                                                data-dept-name="<?= htmlspecialchars($d['name']) ?>"
                                                data-dept-icon="<?= htmlspecialchars($icon) ?>"
                                                data-dept-color="<?= htmlspecialchars($color) ?>"
                                                data-dept-bg="<?= htmlspecialchars($bg) ?>" title="Edit"
                                                style="border: 1px solid var(--sidebar-border); border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                    data-lucide="edit-2" style="width: 12px; height: 12px;"></i></button>
                                            <button class="header-btn btn-dept-delete" data-dept-id="<?= $d['id'] ?>" title="Delete"
                                                style="border: 1px solid var(--sidebar-border); border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                    data-lucide="trash-2" style="width: 12px; height: 12px;"></i></button>
                                        </div>
                                    </div>
                                <?php
                                endforeach;
                    ...
                    <div id="view-clients" class="tab-view">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                ...
                                <div class="standard-search-wrapper">
                                    <i data-lucide="search"></i>
                                    <input type="text" id="clients-search" class="search-input"
                                        placeholder="Search clients...">
                                </div>
                                <!-- Add Client Button -->
                                <button class="btn btn-primary" id="btn-clients-add"
                                    style="height: 32px; padding: 4px 14px; font-size: 11px; background-color: #2563eb;"><i
                                        data-lucide="plus"></i> Add Client</button>
                            </div>
                        </div>
                                ...
                                <table class="table-custom" id="clients-table-list">
                                    ...
                                    <tbody>
                                        <?php if (empty($dropdownClients)): ?>
                                            <tr>
                                                <td colspan="5"
                                                    style="text-align: center; color: var(--text-muted); padding: 20px;">No
                                                    clients registered yet.</td>
                                            </tr>
                                        <?php else: ?>
                                            <?php foreach ($dropdownClients as $c): ?>
                                                <tr class="client-row" data-client-id="<?= $c['id'] ?>"
                                                    data-client-name="<?= htmlspecialchars(strtolower($c['name'])) ?>"
                                                    data-client-email="<?= htmlspecialchars(strtolower($c['email'] ?? '')) ?>"
                                                    data-client-phone="<?= htmlspecialchars($c['phone'] ?? '') ?>">
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div style="display: flex; gap: 8px; justify-content: center;">
                                                            <button class="header-btn btn-client-history"
                                                                data-client-id="<?= $c['id'] ?>" title="View History"
                                                                style="border: 1px solid var(--sidebar-border); border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                                    data-lucide="history"
                                                                    style="width: 12px; height: 12px;"></i></button>
                                                            <button class="header-btn btn-client-edit"
                                                                data-client-id="<?= $c['id'] ?>"
                                                                data-client-name="<?= htmlspecialchars($c['name']) ?>"
                                                                data-client-email="<?= htmlspecialchars($c['email'] ?? '') ?>"
                                                                data-client-phone="<?= htmlspecialchars($c['phone'] ?? '') ?>"
                                                                title="Edit"
                                                                style="border: 1px solid var(--sidebar-border); border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                                    data-lucide="edit-3"
                                                                    style="width: 12px; height: 12px;"></i></button>
                                                            <button class="header-btn btn-client-delete"
                                                                data-client-id="<?= $c['id'] ?>" title="Delete"
                                                                style="border: 1px solid var(--sidebar-border); border-radius: 50%; width: 26px; height: 26px; display: flex; align-items: center; justify-content: center; background: transparent; cursor: pointer; color: var(--text-muted);"><i
                                                                    data-lucide="trash-2"
                                                                    style="width: 12px; height: 12px;"></i></button>
                                                        </div>
                    ...
                    <div id="view-settings" class="tab-view">
                        <div class="settings-grid-layout"
                            style="display: flex; gap: 24px; max-width: 1000px; margin: 0 auto; flex-wrap: wrap;">
                            <!-- Profile Card -->
                            <div class="section-card settings-profile-card"
                                style="flex: 1; min-width: 280px; display: flex; flex-direction: column; align-items: center; text-align: center; padding: 30px;">
                                <div class="settings-avatar-wrapper" style="position: relative; margin-bottom: 20px;">
                                    <div class="settings-large-avatar"
                                        style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: #ffffff; width: 80px; height: 80px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 30px; font-weight: 700; border: 4px solid #ffffff; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
                                        <?= htmlspecialchars($meAvatar) ?>
                                    </div>
                                </div>
                                <h3 style="font-size: 18px; font-weight: 700; color: #0f172a; margin-bottom: 6px;">
                                    <?= htmlspecialchars($meName) ?></h3>
                                <span class="badge"
                                    style="background-color: #eff6ff; color: #2563eb; padding: 4px 12px; border-radius: 9999px; font-size: 11px; font-weight: 600; margin-bottom: 15px;"><?= htmlspecialchars($meRole) ?></span>

                                <div
                                    style="width: 100%; border-top: 1px solid #f1f5f9; padding-top: 15px; text-align: left; font-size: 12.5px; display: flex; flex-direction: column; gap: 10px; color: #475569;">
                                    <div><strong>Employee ID:</strong> <span
                                            style="font-family: monospace; color: #2563eb;"><?= htmlspecialchars($meCode) ?></span>
                                    </div>
                                    <div><strong>Email:</strong> <span><?= htmlspecialchars($me['email'] ?? '') ?></span>
                                    </div>
                                    <div><strong>Status:</strong> <span class="status-badge completed"
                                            style="font-size: 9px; padding: 2px 6px;">Active</span></div>
                                </div>
                            </div>
                            ...
                            <div class="section-card settings-form-card" style="flex: 2; min-width: 400px; padding: 30px;">
                                <div class="card-header"
                                    style="border-bottom: 1px solid #f1f5f9; padding-bottom: 12px; margin-bottom: 20px;">
                                    ...
                                    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 16px;">
                                        <div class="form-group" style="grid-column: span 2;">
                                            ...
                                            <input type="text" name="name" id="set-name" class="form-control"
                                                value="<?= htmlspecialchars($meName) ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="set-role">Role *</label>
                                            <input type="text" name="role" id="set-role" class="form-control"
                                                value="<?= htmlspecialchars($meRole) ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="set-email">Email Address *</label>
                                            <input type="email" name="email" id="set-email" class="form-control"
                                                value="<?= htmlspecialchars($me['email'] ?? '') ?>" autocomplete="username"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="set-code">Employee Code</label>
                                            <input type="text" name="emp_code" id="set-code" class="form-control"
                                                value="<?= htmlspecialchars($meCode) ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="set-avatar">Avatar Initials (e.g. SJ)</label>
                                            <input type="text" name="avatar" id="set-avatar" class="form-control"
                                                value="<?= htmlspecialchars($meAvatar) ?>" maxlength="2">
                                        </div>
                                    </div>
                                    <div class="form-group"
                                        ...
                                        <input type="password" name="password" id="set-password" class="form-control"
                    ...
                    <div class="modal-container" style="max-width: 600px;">
                        ...
                        <form id="form-building" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body" style="display:grid; grid-template-columns:1fr 1fr; gap:15px;">
                                <div class="form-group"><label>Building Name</label><input type="text" name="name"
                                        id="building-name" class="form-control" required></div>
                                <div class="form-group"><label>Type</label><input type="text" name="type"
                                        id="building-type" class="form-control"></div>
                                <div class="form-group" style="grid-column: span 2;"><label>Address</label><textarea
                                        name="address" id="building-address" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group"><label>Total Floors</label><input type="number"
                                        name="total_floors" id="building-floors" class="form-control"></div>
                                <div class="form-group"><label>Total Units</label><input type="number"
                                        name="total_units" id="building-units" class="form-control"></div>
                                <div class="form-group"><label>Total Area (sq.ft)</label><input type="number"
                                        step="0.01" name="total_area" id="building-area" class="form-control"></div>
                                <div class="form-group"><label>Owner Name</label><input type="text" name="owner_name"
                                        id="building-owner" class="form-control"></div>
                                <div class="form-group"><label>Contact Number</label><input type="text"
                                        name="contact_number" id="building-contact" class="form-control"></div>
                                <div class="form-group"><label>Status</label><select name="status" id="building-status"
                                        class="form-control">
                                        <option value="Available">Available</option>
                                        <option value="Sold">Sold</option>
                                        <option value="Rented">Rented</option>
                                    </select></div>
                                <div class="form-group" style="grid-column: span 2;"><label>Document
                                        Upload</label><input type="file" name="document" id="building-doc"
                ...
                <div class="modal-overlay" id="modal-singleplot">
                    <div class="modal-container" style="max-width: 600px;">
                        ...
                        <form id="form-singleplot" method="POST">
                            ...
                            <div class="modal-body" style="display:grid; grid-template-columns:1fr 1fr; gap:15px;">
                                <div class="form-group"><label>Plot Number</label><input type="text" name="plot_number"
                                        id="sp-plot" class="form-control" required></div>
                                <div class="form-group"><label>Layout Name</label><input type="text" name="layout_name"
                                        id="sp-layout" class="form-control"></div>
                                <div class="form-group"><label>Survey Number</label><input type="text"
                                        name="survey_number" id="sp-survey" class="form-control"></div>
                                <div class="form-group"><label>Area</label><input type="number" step="0.01" name="area"
                                        id="sp-area" class="form-control"></div>
                                <div class="form-group"><label>Location</label><input type="text" name="location"
                                        id="sp-location" class="form-control"></div>
                                <div class="form-group"><label>Price</label><input type="number" step="0.01"
                                        name="price" id="sp-price" class="form-control"></div>
                                <div class="form-group"><label>Facing Direction</label><input type="text"
                                        name="facing_direction" id="sp-facing" class="form-control"></div>
                                <div class="form-group"><label>Status</label><select name="status" id="sp-status"
                                        class="form-control">
                                        <option value="Available">Available</option>
                                        <option value="Sold">Sold</option>
                                        <option value="Reserved">Reserved</option>
                                    </select></div>
                                <div class="form-group" style="grid-column: span 2;"><label>Owner Name</label><input
                                        type="text" name="owner_name" id="sp-owner" class="form-control"></div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
                ...
                <div class="modal-overlay" id="modal-ual">
                    <div class="modal-container" style="max-width: 600px;">
                        ...
                        <form id="form-ual" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body" style="display:grid; grid-template-columns:1fr 1fr; gap:15px;">
                                <div class="form-group"><label>Case Number</label><input type="text" name="case_number"
                                        id="ual-case" class="form-control" required></div>
                                <div class="form-group"><label>Owner Name</label><input type="text" name="owner_name"
                                        id="ual-owner" class="form-control"></div>
                                <div class="form-group" style="grid-column: span 2;"><label>Address</label><textarea
                                        name="address" id="ual-address" class="form-control" rows="2"></textarea></div>
                                <div class="form-group"><label>Total Land Area</label><input type="number" step="0.01"
                                        name="total_land_area" id="ual-total" class="form-control"></div>
                                <div class="form-group"><label>Gov Ceiling Limit</label><input type="number" step="0.01"
                                        name="gov_ceiling_limit" id="ual-limit" class="form-control"></div>
                                <div class="form-group"><label>Excess Land Area</label><input type="number" step="0.01"
                                        name="excess_land_area" id="ual-excess" class="form-control"></div>
                                <div class="form-group"><label>Gov Order Number</label><input type="text"
                                        name="gov_order_number" id="ual-order" class="form-control"></div>
                                <div class="form-group"><label>Approval Status</label><select name="approval_status"
                                        id="ual-status" class="form-control">
                                        <option value="Pending">Pending</option>
                                        <option value="Approved">Approved</option>
                                        <option value="Rejected">Rejected</option>
                                    </select></div>
                                <div class="form-group"><label>Document Upload</label><input type="file" name="document"
                                        id="ual-doc" class="form-control"></div>
                                <div class="form-group" style="grid-column: span 2;"><label>Remarks</label><input
                                        type="text" name="remarks" id="ual-remarks" class="form-control"></div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
                ...
                <div class="modal-overlay" id="modal-landsurvey">
                    <div class="modal-container" style="max-width: 600px;">
                        ...
                        <form id="form-landsurvey" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body" style="display:grid; grid-template-columns:1fr 1fr; gap:15px;">
                                <div class="form-group"><label>Survey Number</label><input type="text"
                                        name="survey_number" id="ls-survey" class="form-control" required></div>
                                <div class="form-group"><label>Village Name</label><input type="text"
                                        name="village_name" id="ls-village" class="form-control"></div>
                                <div class="form-group"><label>Taluk</label><input type="text" name="taluk"
                                        id="ls-taluk" class="form-control"></div>
                                <div class="form-group"><label>District</label><input type="text" name="district"
                                        id="ls-district" class="form-control"></div>
                                <div class="form-group"><label>Land Type</label><input type="text" name="land_type"
                                        id="ls-type" class="form-control"></div>
                                <div class="form-group"><label>Owner Name</label><input type="text" name="owner_name"
                                        id="ls-owner" class="form-control"></div>
                                <div class="form-group"><label>Total Area</label><input type="number" step="0.01"
                                        name="total_area" id="ls-area" class="form-control"></div>
                                <div class="form-group"><label>Latitude</label><input type="text" name="latitude"
                                        id="ls-lat" class="form-control"></div>
                                <div class="form-group"><label>Longitude</label><input type="text" name="longitude"
                                        id="ls-long" class="form-control"></div>
                                <div class="form-group"><label>Document Upload</label><input type="file" name="document"
                                        id="ls-doc" class="form-control"></div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
                    ...
                    <div
                        ...
                        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px;">
                            ...
                            <tbody id="survey-management-tbody">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" style="padding: 30px; text-align: center; color: #94a3b8;">No active
                                            survey records found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
            ...
            <form id="form-new-task" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="tk-title" class="form-control"
                            placeholder="e.g. Wireframe customer portal" required>
                    </div>
                    <div class="form-group">
                        <label for="tk-desc">Description</label>
                        <textarea name="description" id="tk-desc" class="form-control" rows="3"
                            placeholder="Provide task requirements..."></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="due_date" id="tk-due" class="form-control"
...
=======
                        <input type="text" id="edit-tk-title" class="form-control" readonly
...
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="p-name" class="form-control"
                            placeholder="e.g. THAMARAI SERVICES" required>
                    </div>
                    <div class="form-group">
                        <label for="p-desc">Description</label>
                        <textarea name="description" id="p-desc" class="form-control" rows="3"
                    ...
                    <div class="form-group">
                        ...
                        <div
                            style="border: 1px solid #e2e8f0; border-radius: 6px; padding: 8px 12px; max-height: 140px; overflow-y: auto; background: #fafafa;">
                            <?php foreach ($dropdownEmployees as $emp): ?>
                                <label
                                    style="display: flex; align-items: center; gap: 8px; padding: 5px 0; cursor: pointer; font-size: 13px; color: #334155;">
                                    <input type="checkbox" name="member_ids[]" value="<?= $emp['id'] ?>"
            ...
            <form id="form-new-client" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="c-name" class="form-control" placeholder="e.g. Suresh Babu"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="c-phone" class="form-control"
                            placeholder="e.g. +91 98480 12345" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
            ...
            <form id="form-new-timesheet" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.25" name="hours" id="ts-hours" class="form-control"
                            placeholder="e.g. 4.5" required>
                    </div>
                    <div class="form-group">
                        <label for="ts-date">Date Logged</label>
                        <input type="date" name="date" id="ts-date" class="form-control" value="<?= date('Y-m-d') ?>"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="ts-desc">Work Notes</label>
                        <textarea name="description" id="ts-desc" class="form-control" rows="3"
                            placeholder="Completed items..." required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
            ...
            <form id="form-new-employee" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="emp-name" class="form-control" placeholder="e.g. Kalpana G"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="emp-role">Role</label>
                        <input type="text" name="role" id="emp-role" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="emp-email" class="form-control"
                            placeholder="e.g. kalpana@vyalasoftware.com" autocomplete="username" required>
                    </div>
                    <div class="form-group">
                        <label for="emp-password">Password</label>
                        <input type="password" name="password" id="emp-password" class="form-control"
                            placeholder="Minimum 6 characters" autocomplete="new-password" required>
                    </div>
                    <div class="form-group">
                        <label for="emp-code">Employee Code (Optional)</label>
                        <input type="text" name="emp_code" id="emp-code" class="form-control"
                            placeholder="e.g. T-130556">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
            ...
            <form id="form-edit-employee" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="edit-emp-email" class="form-control"
                            autocomplete="username" required>
                    </div>
                    <div class="form-group">
                        <label for="edit-emp-password">Password (Optional)</label>
                        <input type="password" name="password" id="edit-emp-password" class="form-control"
            ...
            <form id="form-new-note" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="note-title" class="form-control"
                            placeholder="e.g. Server Credentials" required>
                    </div>
                    <div class="form-group">
                        <label for="note-content">Content</label>
                        <textarea name="content" id="note-content" class="form-control" rows="5"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tags" id="note-tags" class="form-control"
                            placeholder="e.g. credentials, important">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
            ...
            <form id="form-edit-note" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="edit-note-content" class="form-control" rows="5"
                            required></textarea>
                    </div>
                    <div class="form-group">
            ...
            <form id="form-new-discussion" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="disc-title" class="form-control"
                            placeholder="e.g. KILUATTI SERVICES" required>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-overlay" id="modal-client-history">
        <div class="modal-container" style="max-width: 700px; width: 90%;">
            ...
            <div class="modal-body" style="padding: 20px; max-height: 500px; overflow-y: auto;">
                ...
                <div
                    style="display: flex; gap: 20px; border-bottom: 1px solid #e2e8f0; padding-bottom: 10px; margin-bottom: 15px;">
                    <span class="client-history-tab active" data-history-tab="details"
                        style="font-size: 13px; font-weight: 600; color: #2563eb; border-bottom: 2px solid #2563eb; padding-bottom: 8px; cursor: pointer;">Details</span>
                    <span class="client-history-tab" data-history-tab="projects"
                        style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">Projects</span>
                    <span class="client-history-tab" data-history-tab="activities"
                        style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">Activities</span>
                    <span class="client-history-tab" data-history-tab="transactions"
                        style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">Transactions</span>
                    <span class="client-history-tab" data-history-tab="timeline"
                        style="font-size: 13px; font-weight: 600; color: #64748b; padding-bottom: 8px; cursor: pointer;">Timeline</span>
                </div>
        ...
        <div class="modal-container" style="max-width: 440px;">
            ...
            <div class="modal-body" style="padding: 20px;">
                <div class="form-group" style="margin-bottom: 15px;">
                    <div class="standard-search-wrapper" style="width: 100%;">
                        <i data-lucide="search"></i>
                        <input type="text" id="direct-chat-member-search" class="search-input"
                            placeholder="Search team members..." style="background: #f8fafc;">
                    </div>
                </div>
                <div id="direct-chat-users-list"
                    style="display: flex; flex-direction: column; gap: 10px; max-height: 280px; overflow-y: auto; padding-right: 4px;">
                    <!-- Dynamically loaded -->
                </div>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-overlay" id="modal-discussion-members">
        <div class="modal-container" style="max-width: 420px;">
            ...
            <div class="modal-body" style="padding: 20px;">
                <h4
                    style="font-size: 11px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; margin-bottom: 10px; letter-spacing: 0.5px;">
                    Active Members</h4>
                <div id="discussion-active-members-list"
                    style="display: flex; flex-direction: column; gap: 8px; max-height: 180px; overflow-y: auto; margin-bottom: 20px; border: 1px solid var(--card-border); padding: 8px; border-radius: 6px;">
                    <!-- JS rendered -->
                </div>
                <h4
                    style="font-size: 11px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; margin-bottom: 10px; letter-spacing: 0.5px;">
                    Add Team Members</h4>
                <div id="discussion-non-members-list"
                    style="display: flex; flex-direction: column; gap: 8px; max-height: 180px; overflow-y: auto; border: 1px solid var(--card-border); padding: 8px; border-radius: 6px;">
                    <!-- JS rendered -->
                </div>
            </div>
        </div>
    ...
    <div class="modal-overlay" id="modal-doc-preview">
        <div class="modal-container" style="max-width: 640px;">
            ...
            <div class="modal-body" id="doc-preview-body"
                style="text-align: center; max-height: 500px; overflow-y: auto; padding: 20px;">
                <!-- JS rendered -->
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="dept-name" class="form-control"
                            placeholder="e.g. Quality Assurance" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary modal-close-btn">Cancel</button>
...
=======
                <h3
                    style="font-size: 14px; font-weight: 700; color: #0f172a; display: flex; align-items: center; gap: 8px;">
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
...
=======
            <div class="modal-footer"
                style="border-top: 1px solid #f1f5f9; padding-top: 12px; display: flex; justify-content: flex-end;">
>>>>>>> 5d6639863b2014e0b32a7d0fa18a20ed074cf549
                <button type="button" class="btn btn-secondary modal-close-btn">Close</button>
            </div>
        </div>
